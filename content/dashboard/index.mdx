...
- **[Players](/dashboard/players)** — View player sessions and history
- **[Findings](/dashboard/findings)** — Browse all detections
- **[Modules](/dashboard/modules)** — Configure detection modules
- **[Settings](/dashboard/settings)** — Server configuration
