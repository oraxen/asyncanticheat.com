...
- [Speed](/checks/movement#speed) — Horizontal movement speed violations
- [Fly](/checks/movement#fly) — Unauthorized flight detection
- [NoFall](/checks/movement#nofall) — Fall damage bypass
- [Phase](/checks/movement#phase) — Moving through solid blocks
- [Step](/checks/movement#step) — Stepping up blocks too quickly

### Combat Checks

Detect killaura, reach hacks, and other combat cheats.

- [Reach](/checks/combat#reach) — Hitting from too far away
- [Killaura](/checks/combat#killaura) — Automated combat detection
- [Velocity](/checks/combat#velocity) — Knockback modification
- [AutoClicker](/checks/combat#autoclicker) — Abnormal click patterns

### Interaction Checks

Detect scaffold, nuker, and other block interaction cheats.

- [Scaffold](/checks/interaction#scaffold) — Automated bridge building
- [Nuker](/checks/interaction#nuker) — Fast block breaking
- [FastPlace](/checks/interaction#fastplace) — Rapid block placement
- [Inventory](/checks/interaction#inventory) — Inventory manipulation cheats
